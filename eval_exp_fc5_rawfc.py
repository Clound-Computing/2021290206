...
def main():
    ...
    model_url = from_project_root("./RAWFC_model_epoch0_pre0.380000_rec0.380000_micf0.380000_macf0.299607_rouge0.089455.pt")#
    # test_url = from_project_root("dataset/pub_oracles/ruling_oracles_test_checked.tsv")
    test_url = from_project_root("dataset/RAWFC/test/")
