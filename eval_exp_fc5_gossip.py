...
def main():
    ...
    model_url = from_project_root("./_model_epoch0_pre0.872935_rec0.872935_micf0.872935_macf0.811212_rouge0.421647.pt")#
    # test_url = from_project_root("dataset/pub_oracles/ruling_oracles_test_checked.tsv")
    test_url = from_project_root("dataset/gossipcop/test.json")
