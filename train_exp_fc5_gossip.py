...
from eval_exp_fc5_gossip import evaluate_model, loss_func
...
ROOT_PROJ_PATH = os.path.dirname(os.path.dirname(os.path.abspath(__file__))) + "/Codes/dataset/gossipcop/"
